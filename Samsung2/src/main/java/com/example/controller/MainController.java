...
public class MainController {
	...
	public Devices samsung() {
		...
		Device d1=new Device(1,"Galaxy s23 Ultra","Smart Phone--2");
		Device d2=new Device(2,"Galaxy s24 Ultra","Smart Phone--2");
		Device d3=new Device(3,"Galaxy s25 Ultra","Smart Phone--2");
